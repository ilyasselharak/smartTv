...
export default function PrivacyPolicy({packages}) {
  return (
    <>
    <Head>
      <title>IPtvConfig | Policy</title>
      ...
      <meta content='IPTV Provider | Privacy Policy' name='title'/>
...
<h2 className="text-4xl">Information Collection and Use</h2>
<p>We collect several different types of information for various purposes to provide and improve our Service to you.</p>

<h2 className="text-4xl">Types of Data Collected</h2>
<p>Personal Data</p>
...
<h2 className="text-4xl">Usage Data</h2>
...
<h2 className="text-4xl">Tracking Cookies Data</h2>
...
<h2 className="text-4xl">Use of Data</h2>
<p>Digital RS Solutions LLC uses the collected data for various purposes:</p>
...
<h2 className="text-4xl">Retention of Data</h2>
...
<h2 className="text-4xl">Transfer of Data</h2>
...
<p>Digital RS Solutions LLC will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

<h2 className="text-4xl">Disclosure of Data</h2>
...
<h2 className="text-4xl">Security of Data</h2>
...
<p>Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</p>
...
<p>Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</p>
...
<h2 className="text-4xl">Analytics</h2>
...
<h2 className="text-4xl">Links to Other Sites</h2>
